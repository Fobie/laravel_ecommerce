...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="mt-1 font-weight-bold float-left">Category Lists</h6>
      <a href="{{route('category.create')}}" class="btn btn-sm float-right categoryBtn  " data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Category</a>
    </div>
    <div class="card-body">
