        ...
        <div class="card border-left-primary shadow h-100 py-2 ">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              ...
              <div class="col-auto">
                <i class="fas fa-sitemap fa-2x cardIcon"></i>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card border-left-success shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              ...
              <div class="col-auto">
                <i class="fas fa-cubes fa-2x cardIcon"></i>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card border-left-info shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              ...
              <div class="col-auto">
                <i class="fas fa-clipboard-list fa-2x cardIcon"></i>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card border-left-warning shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              ...
              <div class="col-auto">
                <i class="fas fa-folder fa-2x cardIcon"></i>
              </div>
            </div>
          </div>
        </div>
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
    ...
    Chart.defaults.global.defaultFontColor = '#4C4C6D';
                ...
                var myLineChart = new Chart(ctx, {
                  ...
                  data: {
                    ...
                    datasets: [{
                      ...
                      pointBorderColor: "#4C4C6D",
                      pointHoverRadius: 3,
                      pointHoverBackgroundColor: "#1B9C85",
                      pointHoverBorderColor: "#1B9C85",
                      pointHitRadius: 10,
                      pointBorderWidth: 2,
